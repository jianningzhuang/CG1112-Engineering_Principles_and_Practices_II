...
static volatile char dataRecv, dataSend;


ISR(USART_RX_vect) //.. fill in the correct receive interrupt vector ..
{
  // Write received data to dataRecv
  dataRecv = UDR0;
}

ISR(USART_UDRE_vect) //.. fill in the correct UDRE interrupt vector ..
{
